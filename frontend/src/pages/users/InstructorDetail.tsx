...
import { MemoizedInstructorProfileView } from "@/components/profiles/InstructorProfileView";
...
export function InstructorDetail() {
  ...
  const { profile, instructorProfile, loading, error, refetch } =
    useProfileData(id);
        ...
        <Card className="w-full max-w-md">
          <CardContent className="py-8 text-center space-y-4">
            <p className="text-red-500 text-sm">
              {!id ? "Invalid instructor ID" : error}
            </p>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
        ...
        {isEditing ? (
          ...
          <MemoizedInstructorProfileView
            ...
            hireDate={instructorProfile?.hire_date}
