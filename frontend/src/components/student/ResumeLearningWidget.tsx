...
const ResumeLearningWidget = async () => {
  ...
  return (
    <div className="bg-slate-900 rounded-3xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden group select-none animate-in fade-in slide-in-from-bottom-3 duration-300">
      ...
      <div className="relative z-10 max-w-xl flex flex-col justify-between h-full">
        <div>
          <span className="text-[10px] md:text-xs font-black tracking-widest uppercase bg-white/15 px-3 py-1 rounded-full backdrop-blur-md font-mono select-none">
        ...
        <div className="mt-6 flex items-center gap-3">
          <Link 
            href={`/student/lessons/${resumeLearning.lesson_id}?courseId=${resumeLearning.course_id}`}
            className="inline-flex px-5 py-2.5 bg-white text-slate-900 hover:bg-slate-50 text-xs font-black rounded-xl shadow-md transition-all duration-200 items-center gap-1.5 hover:scale-[1.02] active:scale-[0.99]"
          >
