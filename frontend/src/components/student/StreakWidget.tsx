...
const StreakWidget = async () => {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-white border border-slate-200 rounded-2xl shadow-sm hover:scale-[1.02] active:scale-[0.99] transition-all duration-300 self-start md:self-auto select-none animate-in fade-in slide-in-from-top-2">
      <div className="relative flex items-center justify-center h-8 w-8 rounded-full bg-slate-800 shadow-md">
        <span className="text-base text-white animate-bounce" style={{ animationDuration: "2s" }}>🔥</span>
      </div>
      <div className="flex flex-col text-left">
        <span className="text-[9px] font-extrabold text-slate-500 tracking-wider uppercase font-mono">
          Learning Streak
        </span>
