...
export function AddParentDialog({ onParentAdded }: AddParentDialogProps) {
  ...
  const handleAddParent = async () => {
    ...
    setLoading(true);
    try {
      // Step 1: Create User with parent role
      ...
      await api.post(`/parents/${userId}/profile`, {});
      ...
      toast.error(
        error.response?.data?.detail || "Failed to create parent"
      );
      console.log(error);
    } finally {
      setLoading(false);
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new parent account. Fill in the basic information.
          </DialogDescription>
        </DialogHeader>
