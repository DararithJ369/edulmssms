    ...
    <div>
      ...
      <main className="">
        ...
        <section className="py-24 bg-white dark:bg-[#121212] overflow-hidden relative">
          <div className="absolute top-0 right-0 w-1/3 h-full bg-[#0038A8]/5 blur-[100px] rounded-full"></div>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="mb-8 flex justify-center">
              <div className="w-16 h-1 bg-[#0038A8] rounded-full"></div>
            </div>
            <h3 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-10 leading-tight">
              &ldquo;The multidisciplinary approach at Edunexus prepared me for a career that didn&apos;t even exist when I started my degree.&rdquo;
            </h3>
            <div className="flex flex-col items-center">
              <img
                src="https://picsum.photos/seed/edunexus-student/100/100"
                alt="Sarah Chen"
                className="w-20 h-20 rounded-full border-4 border-[#0038A8] mb-4 object-cover"
              />
              <p className="text-xl font-bold text-gray-900 dark:text-white">
                Sarah Chen
              </p>
              <p className="text-[#0038A8] font-medium">
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-r from-gray-50 to-white dark:from-[#1c1c1c] dark:to-[#2a2a2a] rounded-[3rem] p-12 md:p-20 text-center border border-gray-200 dark:border-gray-800 relative overflow-hidden shadow-xl dark:shadow-none">
              <div className="absolute top-0 left-0 w-full h-1 bg-[#0038A8]"></div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a
                  href="/login"
                  className="bg-[#0038A8] text-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-[#002D86] transition-all transform hover:scale-105 shadow-lg shadow-[#0038A8]/20 inline-block"
                >
                  Apply Now
                </a>
