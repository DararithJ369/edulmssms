        ...
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold tracking-tight text-foreground">
              EDU<span className="text-[#3ecf8e]">LAMS</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a
              href="#home"
              className="ttext-foreground hover:text-[#3ecf8e] transition-colors font-medium"
            >
              Overview
            </a>
            <a
              href="#programs"
              className="text-foreground hover:text-[#3ecf8e] transition-colors font-medium"
            >
              Programs
            </a>
            <a
